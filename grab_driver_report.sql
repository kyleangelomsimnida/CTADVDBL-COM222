...
DROP TABLE IF EXISTS `driver_report`;
...
LOCK TABLES `driver_report` WRITE;
/*!40000 ALTER TABLE `driver_report` DISABLE KEYS */;
/*!40000 ALTER TABLE `driver_report` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-06-23 19:12:18
